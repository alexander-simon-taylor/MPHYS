...
function history = single_particle_path(number,ds,x0,y0,z0,vx0,vy0,vz0,field_choice,...
    ...
    fclose('all');
    r = [x0,y0,z0,vx0,vy0,vz0];
    for i = 1:number_of_saves
        history = zeros(number_per_save,6);
        for j = 1:number_per_save
            r = all_methods_particle_paths(r(1),r(2),r(3),r(4),r(5),r(6),field_choice,method_choice,...
